                ...
                <div class="col col-xl-10">
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                          ...
                          <form action="{{route("login")}}" method="POST">
                            ...
                            <div class="d-flex justify-content-center align-items-center mb-3 pb-1">
                              <i class="fas fa-cubes fa-2x me-3" style="color: #ff8fab;"></i>
                              <span class="h1 fw-bold mb-0" style="color: #ff8fab;">TODOLIST</span>
                          </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <label class="form-label" for="form2Example17" style="color: #ff8fab;">E-mail 
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                              ...
                              <label class="form-label" for="form2Example27" style="color: #ff8fab;">Contraseña
                            ...
                            <div class="text-center">
                              <p class="mb-3 pb-lg-2" style="color: #ffafcc; font-weight: 600;">¿Aún no tienes una cuenta?  </p>
                          </div>
                          
                          <div class="d-flex justify-content-center">
                            <a href="{{route('register')}}" class="btn btn-lg btn-block" style="background-color: #ffafcc; color: white; border: none; max-width: 300px; font-weight: 700; font-size: 1.25rem; padding: 10px 25px; border-radius: 50px;">
                                Regístrate 
                            </a>
                        </div>
